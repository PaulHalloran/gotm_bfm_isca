...
!
  ...
  real(RLEN)  :: p_minfood(iiMesoZooPlankton)  ! limitfood uptake by low concentrations
  ...
  real(RLEN)  :: p_emd(iiMesoZooPlankton)  ! Exponent of density-dependent mortality
  ...
  namelist /MesoZoo_parameters/ p_q10, p_srm,p_srs, p_puPI, p_puMIZ, p_puMEZ, p_sd, &
    p_sum, p_vum, p_minfood,p_pur, p_peuPI,p_peuR3,p_peuMIZ,p_peuMEZ, &
    p_smd,p_emd, p_qpc, p_qnc, p_clO2o, p_sw_nut_part,p_sw_faecelpell_sed
