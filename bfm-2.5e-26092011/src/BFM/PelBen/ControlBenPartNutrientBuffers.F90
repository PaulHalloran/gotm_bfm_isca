  ...
  DO BoxNumberY=1,NO_BOXES_Y
    DO BoxNumberX=1,NO_BOXES_X
      ...
      if ( p_control_n) then
        ...
        if ( -jbotR6n(BoxNumberXY)< p_rn .AND. Q6n(BoxNumberXY)/ rate< p_refill_time) then
          rate  =   max(  0.0D+00,  rate+ jbotR6n(BoxNumberXY))
          call flux(BoxNumberXY, iiBen, ppQ6n, ppQ6n, -(- rate) )
          call flux(BoxNumberXY, iiBen, ppD7m, ppD7m, ( 0.0D+00- &
      ...
      if ( p_control_p) then
        ...
        if ( -jbotR6p(BoxNumberXY)< r .AND. Q6p(BoxNumberXY)/ rate< p_refill_time) then
          rate  =   max(  0.0D+00,  rate+ jbotR6p(BoxNumberXY))
          call flux(BoxNumberXY, iiBen, ppQ6p, ppQ6p, -(- rate) )
          call flux(BoxNumberXY, iiBen, ppD8m, ppD8m, ( 0.0D+00- &
      ...
      if ( p_control_s) then
        ...
        if ( -jbotR6s(BoxNumberXY)< r .AND. Q6s(BoxNumberXY)/ rate< p_refill_time) then
