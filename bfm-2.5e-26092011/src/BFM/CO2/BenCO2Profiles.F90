...
! !USES:
        ...
        USE constants, ONLY: INTEGRAL,STANDARD,GET,LABDA_2
...
!
        ...
        IMPLICIT  NONE
        integer    ::error
        REAL(RLEN)    ::r,s,dumCO2,dumHCO3,dumCO3,dumpCO2,AcMin
            ...
            DO BoxNumberX=1,NO_BOXES_X
             ...
             if (llpH) then
               error= CalcCO2System(MethodCalcCO2,ESW_Ben(BoxNumberXY), &
                   ...
                   PrM1p(BoxNumber),max(0.0,PrM5s(BoxNumber)),PrAc(BoxNumber),&
