...
#ENDIF
  use mem, ONLY: ppD6m, ppD7m, ppD8m, ppD9m, &
    turenh, irrenh, ETW_Ben, NO_BOXES_XY, iiBen, flux_vector
...
!
  ...
  Yirr  =   Y2c(:)+ Y5c(:)+ p_irrY4* Y4c(:) +p_irrY3 * Y3c(:)
