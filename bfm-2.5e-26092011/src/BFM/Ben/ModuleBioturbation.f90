...
!
  ...
  !  bioturbation
  real(RLEN)  :: p_irrY3  ! -       # Multiplication factor to correct influence of a group of Y3 on bioirrigation
  real(RLEN)  :: p_irrY4  ! -       # Multiplication factor to correct influence of a group of Y4 on bioirrigation
