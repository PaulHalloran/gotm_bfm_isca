...
!
  ...
  !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    ...
    allocate(seddepth(1:NO_BOXES_Z),stat=status)
    if (status /= 0) call error_msg_prn(ALLOC,"AllocateMem", "seddepth")

    call calc_sigma_depth(NO_BOXES_Z,2.0D+00,0.3D+00,seddepth)
    !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  ...
  write(LOGUNIT,*) "# Allocating Other Global Variables .."
    ...
    PrM1p => D3DIAGNOS(ppPrM1p,:); PrM1p=ZERO
    Pr2M1p => D3DIAGNOS(ppPr2M1p,:); Pr2M1p=ZERO
    PrM3n => D3DIAGNOS(ppPrM3n,:); PrM3n=ZERO
    PrM4n => D3DIAGNOS(ppPrM4n,:); PrM4n=ZERO
    PrM5s => D3DIAGNOS(ppPrM5s,:); PrM5s=ZERO
    PrM6r => D3DIAGNOS(ppPrM6r,:); PrM6r=ZERO
    PrQ1c => D3DIAGNOS(ppPrQ1c,:); PrQ1c=ZERO
    PrDIC => D3DIAGNOS(ppPrDIC,:); PrDIC=ZERO
    PrAc => D3DIAGNOS(ppPrAc,:); PrAc=ZERO
    PrpH => D3DIAGNOS(ppPrpH,:); PrpH=ZERO
  ...
  !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    ...
    pppuPIY3(iiP5)=185
    pppuPIY3(iiP6)=186
    ppsediPI_Ben(iiP1)=187
    ppsediPI_Ben(iiP2)=188
    ppsediPI_Ben(iiP3)=189
    ppsediPI_Ben(iiP4)=190
    ppsediPI_Ben(iiP5)=191
    ppsediPI_Ben(iiP6)=192
    ...
    jPIY3n => D2DIAGNOS(ppjPIY3n,:); jPIY3n=ZERO
    jPIY3p => D2DIAGNOS(ppjPIY3p,:); jPIY3p=ZERO
    ...
    jeZIR6n => D2DIAGNOS(ppjeZIR6n,:); jeZIR6n=ZERO
    jeZIR6p => D2DIAGNOS(ppjeZIR6p,:); jeZIR6p=ZERO
    jeZIDIn => D2DIAGNOS(ppjeZIDIn,:); jeZIDIn=ZERO
    jeZIDIp => D2DIAGNOS(ppjeZIDIp,:); jeZIDIp=ZERO
  ...
  !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    ...
    PELSURFACE => D2DIAGNOS(192+1:192+56,:); PELSURFACE=ZERO
    jsurR9x => D2DIAGNOS(192+ppR9x,:); jsurR9x=ZERO
    jsurO2o => D2DIAGNOS(192+ppO2o,:); jsurO2o=ZERO
    jsurN1p => D2DIAGNOS(192+ppN1p,:); jsurN1p=ZERO
    jsurN3n => D2DIAGNOS(192+ppN3n,:); jsurN3n=ZERO
    jsurN4n => D2DIAGNOS(192+ppN4n,:); jsurN4n=ZERO
    jsurO4n => D2DIAGNOS(192+ppO4n,:); jsurO4n=ZERO
    jsurN5s => D2DIAGNOS(192+ppN5s,:); jsurN5s=ZERO
    jsurN6r => D2DIAGNOS(192+ppN6r,:); jsurN6r=ZERO
    jsurB1c => D2DIAGNOS(192+ppB1c,:); jsurB1c=ZERO
    jsurB1n => D2DIAGNOS(192+ppB1n,:); jsurB1n=ZERO
    jsurB1p => D2DIAGNOS(192+ppB1p,:); jsurB1p=ZERO
    jsurP1c => D2DIAGNOS(192+ppP1c,:); jsurP1c=ZERO
    jsurP1n => D2DIAGNOS(192+ppP1n,:); jsurP1n=ZERO
    jsurP1p => D2DIAGNOS(192+ppP1p,:); jsurP1p=ZERO
    jsurP1l => D2DIAGNOS(192+ppP1l,:); jsurP1l=ZERO
    jsurP1s => D2DIAGNOS(192+ppP1s,:); jsurP1s=ZERO
    jsurP2c => D2DIAGNOS(192+ppP2c,:); jsurP2c=ZERO
    jsurP2n => D2DIAGNOS(192+ppP2n,:); jsurP2n=ZERO
    jsurP2p => D2DIAGNOS(192+ppP2p,:); jsurP2p=ZERO
    jsurP2l => D2DIAGNOS(192+ppP2l,:); jsurP2l=ZERO
    jsurP3c => D2DIAGNOS(192+ppP3c,:); jsurP3c=ZERO
    jsurP3n => D2DIAGNOS(192+ppP3n,:); jsurP3n=ZERO
    jsurP3p => D2DIAGNOS(192+ppP3p,:); jsurP3p=ZERO
    jsurP3l => D2DIAGNOS(192+ppP3l,:); jsurP3l=ZERO
    jsurP4c => D2DIAGNOS(192+ppP4c,:); jsurP4c=ZERO
    jsurP4n => D2DIAGNOS(192+ppP4n,:); jsurP4n=ZERO
    jsurP4p => D2DIAGNOS(192+ppP4p,:); jsurP4p=ZERO
    jsurP4l => D2DIAGNOS(192+ppP4l,:); jsurP4l=ZERO
    jsurP5c => D2DIAGNOS(192+ppP5c,:); jsurP5c=ZERO
    jsurP5n => D2DIAGNOS(192+ppP5n,:); jsurP5n=ZERO
    jsurP5p => D2DIAGNOS(192+ppP5p,:); jsurP5p=ZERO
    jsurP5l => D2DIAGNOS(192+ppP5l,:); jsurP5l=ZERO
    jsurP5s => D2DIAGNOS(192+ppP5s,:); jsurP5s=ZERO
    jsurP6c => D2DIAGNOS(192+ppP6c,:); jsurP6c=ZERO
    jsurP6n => D2DIAGNOS(192+ppP6n,:); jsurP6n=ZERO
    jsurP6p => D2DIAGNOS(192+ppP6p,:); jsurP6p=ZERO
    jsurP6l => D2DIAGNOS(192+ppP6l,:); jsurP6l=ZERO
    jsurPcc => D2DIAGNOS(192+ppPcc,:); jsurPcc=ZERO
    jsurR1c => D2DIAGNOS(192+ppR1c,:); jsurR1c=ZERO
    jsurR1n => D2DIAGNOS(192+ppR1n,:); jsurR1n=ZERO
    jsurR1p => D2DIAGNOS(192+ppR1p,:); jsurR1p=ZERO
    jsurR2c => D2DIAGNOS(192+ppR2c,:); jsurR2c=ZERO
    jsurR3c => D2DIAGNOS(192+ppR3c,:); jsurR3c=ZERO
    jsurR6c => D2DIAGNOS(192+ppR6c,:); jsurR6c=ZERO
    jsurR6n => D2DIAGNOS(192+ppR6n,:); jsurR6n=ZERO
    jsurR6p => D2DIAGNOS(192+ppR6p,:); jsurR6p=ZERO
    jsurR6s => D2DIAGNOS(192+ppR6s,:); jsurR6s=ZERO
    jsurR7c => D2DIAGNOS(192+ppR7c,:); jsurR7c=ZERO
    jsurRZc => D2DIAGNOS(192+ppRZc,:); jsurRZc=ZERO
    jsurO3c => D2DIAGNOS(192+ppO3c,:); jsurO3c=ZERO
    jsurO3h => D2DIAGNOS(192+ppO3h,:); jsurO3h=ZERO
    jsurZ3c => D2DIAGNOS(192+ppZ3c,:); jsurZ3c=ZERO
    jsurZ4c => D2DIAGNOS(192+ppZ4c,:); jsurZ4c=ZERO
    jsurZ2c => D2DIAGNOS(192+ppZ2c,:); jsurZ2c=ZERO
    jsurZ5c => D2DIAGNOS(192+ppZ5c,:); jsurZ5c=ZERO
    jsurZ6c => D2DIAGNOS(192+ppZ6c,:); jsurZ6c=ZERO

    PELBOTTOM => D2DIAGNOS(248+1:248+56,:); PELBOTTOM=ZERO
    jbotR9x => D2DIAGNOS(248+ppR9x,:); jbotR9x=ZERO
    jbotO2o => D2DIAGNOS(248+ppO2o,:); jbotO2o=ZERO
    jbotN1p => D2DIAGNOS(248+ppN1p,:); jbotN1p=ZERO
    jbotN3n => D2DIAGNOS(248+ppN3n,:); jbotN3n=ZERO
    jbotN4n => D2DIAGNOS(248+ppN4n,:); jbotN4n=ZERO
    jbotO4n => D2DIAGNOS(248+ppO4n,:); jbotO4n=ZERO
    jbotN5s => D2DIAGNOS(248+ppN5s,:); jbotN5s=ZERO
    jbotN6r => D2DIAGNOS(248+ppN6r,:); jbotN6r=ZERO
    jbotB1c => D2DIAGNOS(248+ppB1c,:); jbotB1c=ZERO
    jbotB1n => D2DIAGNOS(248+ppB1n,:); jbotB1n=ZERO
    jbotB1p => D2DIAGNOS(248+ppB1p,:); jbotB1p=ZERO
    jbotP1c => D2DIAGNOS(248+ppP1c,:); jbotP1c=ZERO
    jbotP1n => D2DIAGNOS(248+ppP1n,:); jbotP1n=ZERO
    jbotP1p => D2DIAGNOS(248+ppP1p,:); jbotP1p=ZERO
    jbotP1l => D2DIAGNOS(248+ppP1l,:); jbotP1l=ZERO
    jbotP1s => D2DIAGNOS(248+ppP1s,:); jbotP1s=ZERO
    jbotP2c => D2DIAGNOS(248+ppP2c,:); jbotP2c=ZERO
    jbotP2n => D2DIAGNOS(248+ppP2n,:); jbotP2n=ZERO
    jbotP2p => D2DIAGNOS(248+ppP2p,:); jbotP2p=ZERO
    jbotP2l => D2DIAGNOS(248+ppP2l,:); jbotP2l=ZERO
    jbotP3c => D2DIAGNOS(248+ppP3c,:); jbotP3c=ZERO
    jbotP3n => D2DIAGNOS(248+ppP3n,:); jbotP3n=ZERO
    jbotP3p => D2DIAGNOS(248+ppP3p,:); jbotP3p=ZERO
    jbotP3l => D2DIAGNOS(248+ppP3l,:); jbotP3l=ZERO
    jbotP4c => D2DIAGNOS(248+ppP4c,:); jbotP4c=ZERO
    jbotP4n => D2DIAGNOS(248+ppP4n,:); jbotP4n=ZERO
    jbotP4p => D2DIAGNOS(248+ppP4p,:); jbotP4p=ZERO
    jbotP4l => D2DIAGNOS(248+ppP4l,:); jbotP4l=ZERO
    jbotP5c => D2DIAGNOS(248+ppP5c,:); jbotP5c=ZERO
    jbotP5n => D2DIAGNOS(248+ppP5n,:); jbotP5n=ZERO
    jbotP5p => D2DIAGNOS(248+ppP5p,:); jbotP5p=ZERO
    jbotP5l => D2DIAGNOS(248+ppP5l,:); jbotP5l=ZERO
    jbotP5s => D2DIAGNOS(248+ppP5s,:); jbotP5s=ZERO
    jbotP6c => D2DIAGNOS(248+ppP6c,:); jbotP6c=ZERO
    jbotP6n => D2DIAGNOS(248+ppP6n,:); jbotP6n=ZERO
    jbotP6p => D2DIAGNOS(248+ppP6p,:); jbotP6p=ZERO
    jbotP6l => D2DIAGNOS(248+ppP6l,:); jbotP6l=ZERO
    jbotPcc => D2DIAGNOS(248+ppPcc,:); jbotPcc=ZERO
    jbotR1c => D2DIAGNOS(248+ppR1c,:); jbotR1c=ZERO
    jbotR1n => D2DIAGNOS(248+ppR1n,:); jbotR1n=ZERO
    jbotR1p => D2DIAGNOS(248+ppR1p,:); jbotR1p=ZERO
    jbotR2c => D2DIAGNOS(248+ppR2c,:); jbotR2c=ZERO
    jbotR3c => D2DIAGNOS(248+ppR3c,:); jbotR3c=ZERO
    jbotR6c => D2DIAGNOS(248+ppR6c,:); jbotR6c=ZERO
    jbotR6n => D2DIAGNOS(248+ppR6n,:); jbotR6n=ZERO
    jbotR6p => D2DIAGNOS(248+ppR6p,:); jbotR6p=ZERO
    jbotR6s => D2DIAGNOS(248+ppR6s,:); jbotR6s=ZERO
    jbotR7c => D2DIAGNOS(248+ppR7c,:); jbotR7c=ZERO
    jbotRZc => D2DIAGNOS(248+ppRZc,:); jbotRZc=ZERO
    jbotO3c => D2DIAGNOS(248+ppO3c,:); jbotO3c=ZERO
    jbotO3h => D2DIAGNOS(248+ppO3h,:); jbotO3h=ZERO
    jbotZ3c => D2DIAGNOS(248+ppZ3c,:); jbotZ3c=ZERO
    jbotZ4c => D2DIAGNOS(248+ppZ4c,:); jbotZ4c=ZERO
    jbotZ2c => D2DIAGNOS(248+ppZ2c,:); jbotZ2c=ZERO
    jbotZ5c => D2DIAGNOS(248+ppZ5c,:); jbotZ5c=ZERO
    jbotZ6c => D2DIAGNOS(248+ppZ6c,:); jbotZ6c=ZERO
...
!    3d-state-field-alloc-pointer river
    ...
    allocate(KCO2(1:NO_BOXES_XY), stat=status); KCO2 = ZERO
    allocate(KHPLUS(1:NO_BOXES_XY), stat=status); KHPLUS = ZERO

  !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  ! Start the allocation of vars for calculation of combined fluxes for output
  !-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

    allocate(flx_calc_nr(0:44),stat=status)
    allocate(flx_CalcIn(1:44),stat=status)
    allocate(flx_option(1:44),stat=status)
    allocate(flx_t(1:269),stat=status)
    allocate(flx_SS(1:269),stat=status)
    allocate(flx_states(1:269),stat=status)
    allocate(flx_ostates(1:269),stat=status)
    flx_calc_nr(0)=0
    flx_cal_ben_start=9
    ...
    flx_calc_nr(10)= 133; flx_CalcIn(10)=iiPel; flx_option(10)=2
    flx_t(127)=+1.00;flx_SS(127)=0; flx_states(127)=ppP1c
    flx_ostates(127)=ppO3c
    flx_t(128)=+1.00;flx_SS(128)=0; flx_states(128)=ppP2c
    flx_ostates(128)=ppO3c
    flx_t(129)=+1.00;flx_SS(129)=0; flx_states(129)=ppP3c
    flx_ostates(129)=ppO3c
    flx_t(130)=+1.00;flx_SS(130)=0; flx_states(130)=ppP4c
    flx_ostates(130)=ppO3c
    flx_t(131)=+1.00;flx_SS(131)=0; flx_states(131)=ppP5c
    flx_ostates(131)=ppO3c
    flx_t(132)=+1.00;flx_SS(132)=0; flx_states(132)=ppP6c
    flx_ostates(132)=ppO3c
    flx_t(133)=+1.00;flx_SS(133)=0; flx_states(133)=ppPcc
    flx_ostates(133)=ppO3c

    ! netPPm2=(P.c<- O3c)-(P.c->O3c)        (flux perm2):
    flx_calc_nr(11)= 147; flx_CalcIn(11)=iiPel; flx_option(11)=2
    flx_t(134)=+1.00;flx_SS(134)=0; flx_states(134)=ppP1c
    flx_ostates(134)=ppO3c
    flx_t(135)=-1.00;flx_SS(135)=1; flx_states(135)=ppP1c
    flx_ostates(135)=ppO3c
    flx_t(136)=+1.00;flx_SS(136)=0; flx_states(136)=ppP2c
    flx_ostates(136)=ppO3c
    flx_t(137)=-1.00;flx_SS(137)=1; flx_states(137)=ppP2c
    flx_ostates(137)=ppO3c
    flx_t(138)=+1.00;flx_SS(138)=0; flx_states(138)=ppP3c
    flx_ostates(138)=ppO3c
    flx_t(139)=-1.00;flx_SS(139)=1; flx_states(139)=ppP3c
    flx_ostates(139)=ppO3c
    flx_t(140)=+1.00;flx_SS(140)=0; flx_states(140)=ppP4c
    flx_ostates(140)=ppO3c
    flx_t(141)=-1.00;flx_SS(141)=1; flx_states(141)=ppP4c
    flx_ostates(141)=ppO3c
    flx_t(142)=+1.00;flx_SS(142)=0; flx_states(142)=ppP5c
    flx_ostates(142)=ppO3c
    flx_t(143)=-1.00;flx_SS(143)=1; flx_states(143)=ppP5c
    flx_ostates(143)=ppO3c
    flx_t(144)=+1.00;flx_SS(144)=0; flx_states(144)=ppP6c
    flx_ostates(144)=ppO3c
    flx_t(145)=-1.00;flx_SS(145)=1; flx_states(145)=ppP6c
    flx_ostates(145)=ppO3c
    flx_t(146)=+1.00;flx_SS(146)=0; flx_states(146)=ppPcc
    flx_ostates(146)=ppO3c
    flx_t(147)=-1.00;flx_SS(147)=1; flx_states(147)=ppPcc
    flx_ostates(147)=ppO3c

    ! juDIPTn=P.n <- N3n+N4n+R1n        (flux perm2):
    flx_calc_nr(12)= 165; flx_CalcIn(12)=iiPel; flx_option(12)=2
    flx_t(148)=+1.00;flx_SS(148)=0; flx_states(148)=ppP1n
    flx_ostates(148)=ppN3n
    flx_t(149)=+1.00;flx_SS(149)=0; flx_states(149)=ppP1n
    flx_ostates(149)=ppN4n
    flx_t(150)=+1.00;flx_SS(150)=0; flx_states(150)=ppP1n
    flx_ostates(150)=ppR1n
    flx_t(151)=+1.00;flx_SS(151)=0; flx_states(151)=ppP2n
    flx_ostates(151)=ppN3n
    flx_t(152)=+1.00;flx_SS(152)=0; flx_states(152)=ppP2n
    flx_ostates(152)=ppN4n
    flx_t(153)=+1.00;flx_SS(153)=0; flx_states(153)=ppP2n
    flx_ostates(153)=ppR1n
    flx_t(154)=+1.00;flx_SS(154)=0; flx_states(154)=ppP3n
    flx_ostates(154)=ppN3n
    flx_t(155)=+1.00;flx_SS(155)=0; flx_states(155)=ppP3n
    flx_ostates(155)=ppN4n
    flx_t(156)=+1.00;flx_SS(156)=0; flx_states(156)=ppP3n
    flx_ostates(156)=ppR1n
    flx_t(157)=+1.00;flx_SS(157)=0; flx_states(157)=ppP4n
    flx_ostates(157)=ppN3n
    flx_t(158)=+1.00;flx_SS(158)=0; flx_states(158)=ppP4n
    flx_ostates(158)=ppN4n
    flx_t(159)=+1.00;flx_SS(159)=0; flx_states(159)=ppP4n
    flx_ostates(159)=ppR1n
    flx_t(160)=+1.00;flx_SS(160)=0; flx_states(160)=ppP5n
    flx_ostates(160)=ppN3n
    flx_t(161)=+1.00;flx_SS(161)=0; flx_states(161)=ppP5n
    flx_ostates(161)=ppN4n
    flx_t(162)=+1.00;flx_SS(162)=0; flx_states(162)=ppP5n
    flx_ostates(162)=ppR1n
    flx_t(163)=+1.00;flx_SS(163)=0; flx_states(163)=ppP6n
    flx_ostates(163)=ppN3n
    flx_t(164)=+1.00;flx_SS(164)=0; flx_states(164)=ppP6n
    flx_ostates(164)=ppN4n
    flx_t(165)=+1.00;flx_SS(165)=0; flx_states(165)=ppP6n
    flx_ostates(165)=ppR1n

    ! juDIPTp=P.p <- N1p+R1p        (flux perm2):
    flx_calc_nr(13)= 177; flx_CalcIn(13)=iiPel; flx_option(13)=2
    flx_t(166)=+1.00;flx_SS(166)=0; flx_states(166)=ppP1p
    flx_ostates(166)=ppN1p
    flx_t(167)=+1.00;flx_SS(167)=0; flx_states(167)=ppP1p
    flx_ostates(167)=ppR1p
    flx_t(168)=+1.00;flx_SS(168)=0; flx_states(168)=ppP2p
    flx_ostates(168)=ppN1p
    flx_t(169)=+1.00;flx_SS(169)=0; flx_states(169)=ppP2p
    flx_ostates(169)=ppR1p
    flx_t(170)=+1.00;flx_SS(170)=0; flx_states(170)=ppP3p
    flx_ostates(170)=ppN1p
    flx_t(171)=+1.00;flx_SS(171)=0; flx_states(171)=ppP3p
    flx_ostates(171)=ppR1p
    flx_t(172)=+1.00;flx_SS(172)=0; flx_states(172)=ppP4p
    flx_ostates(172)=ppN1p
    flx_t(173)=+1.00;flx_SS(173)=0; flx_states(173)=ppP4p
    flx_ostates(173)=ppR1p
    flx_t(174)=+1.00;flx_SS(174)=0; flx_states(174)=ppP5p
    flx_ostates(174)=ppN1p
    flx_t(175)=+1.00;flx_SS(175)=0; flx_states(175)=ppP5p
    flx_ostates(175)=ppR1p
    flx_t(176)=+1.00;flx_SS(176)=0; flx_states(176)=ppP6p
    flx_ostates(176)=ppN1p
    flx_t(177)=+1.00;flx_SS(177)=0; flx_states(177)=ppP6p
    flx_ostates(177)=ppR1p

    ! juDIB1n=B1n <- N3n+N4n+R1n        (flux perm2):
    flx_calc_nr(14)= 180; flx_CalcIn(14)=iiPel; flx_option(14)=2
    flx_t(178)=+1.00;flx_SS(178)=0; flx_states(178)=ppB1n
    flx_ostates(178)=ppN3n
    flx_t(179)=+1.00;flx_SS(179)=0; flx_states(179)=ppB1n
    flx_ostates(179)=ppN4n
    flx_t(180)=+1.00;flx_SS(180)=0; flx_states(180)=ppB1n
    flx_ostates(180)=ppR1n

    ! juDIB1p=B1p <- N1p+R1p        (flux perm2):
    flx_calc_nr(15)= 182; flx_CalcIn(15)=iiPel; flx_option(15)=2
    flx_t(181)=+1.00;flx_SS(181)=0; flx_states(181)=ppB1p
    flx_ostates(181)=ppN1p
    flx_t(182)=+1.00;flx_SS(182)=0; flx_states(182)=ppB1p
    flx_ostates(182)=ppR1p

    ! juPOB1n=B1n <- R6n        (flux perm2):
    flx_calc_nr(16)= 183; flx_CalcIn(16)=iiPel; flx_option(16)=2
    flx_t(183)=+1.00;flx_SS(183)=0; flx_states(183)=ppB1n
    flx_ostates(183)=ppR6n

    ! juPOB1p=B1p <- R6p        (flux perm2):
    flx_calc_nr(17)= 184; flx_CalcIn(17)=iiPel; flx_option(17)=2
    flx_t(184)=+1.00;flx_SS(184)=0; flx_states(184)=ppB1p
    flx_ostates(184)=ppR6p

    ! jeB1DIn=B1n -> N4n        (flux perm2):
    flx_calc_nr(18)= 185; flx_CalcIn(18)=iiPel; flx_option(18)=2
    flx_t(185)=+1.00;flx_SS(185)=1; flx_states(185)=ppB1n
    flx_ostates(185)=ppN4n

    ! jeB1DIp=B1p -> N1p        (flux perm2):
    flx_calc_nr(19)= 186; flx_CalcIn(19)=iiPel; flx_option(19)=2
    flx_t(186)=+1.00;flx_SS(186)=1; flx_states(186)=ppB1p
    flx_ostates(186)=ppN1p

    ! jePT_ZPOn=R6n<-B1n+P.n        (flux perm2):
    flx_calc_nr(20)= 193; flx_CalcIn(20)=iiPel; flx_option(20)=2
    flx_t(187)=+1.00;flx_SS(187)=0; flx_states(187)=ppR6n
    flx_ostates(187)=ppB1n
    flx_t(188)=+1.00;flx_SS(188)=0; flx_states(188)=ppR6n
    flx_ostates(188)=ppP1n
    flx_t(189)=+1.00;flx_SS(189)=0; flx_states(189)=ppR6n
    flx_ostates(189)=ppP2n
    flx_t(190)=+1.00;flx_SS(190)=0; flx_states(190)=ppR6n
    flx_ostates(190)=ppP3n
    flx_t(191)=+1.00;flx_SS(191)=0; flx_states(191)=ppR6n
    flx_ostates(191)=ppP4n
    flx_t(192)=+1.00;flx_SS(192)=0; flx_states(192)=ppR6n
    flx_ostates(192)=ppP5n
    flx_t(193)=+1.00;flx_SS(193)=0; flx_states(193)=ppR6n
    flx_ostates(193)=ppP6n

    ! jePT_ZPOp=R6p<-B1p+P.p        (flux perm2):
    flx_calc_nr(21)= 200; flx_CalcIn(21)=iiPel; flx_option(21)=2
    flx_t(194)=+1.00;flx_SS(194)=0; flx_states(194)=ppR6p
    flx_ostates(194)=ppB1p
    flx_t(195)=+1.00;flx_SS(195)=0; flx_states(195)=ppR6p
    flx_ostates(195)=ppP1p
    flx_t(196)=+1.00;flx_SS(196)=0; flx_states(196)=ppR6p
    flx_ostates(196)=ppP2p
    flx_t(197)=+1.00;flx_SS(197)=0; flx_states(197)=ppR6p
    flx_ostates(197)=ppP3p
    flx_t(198)=+1.00;flx_SS(198)=0; flx_states(198)=ppR6p
    flx_ostates(198)=ppP4p
    flx_t(199)=+1.00;flx_SS(199)=0; flx_states(199)=ppR6p
    flx_ostates(199)=ppP5p
    flx_t(200)=+1.00;flx_SS(200)=0; flx_states(200)=ppR6p
    flx_ostates(200)=ppP6p

    ! jP1ZIc=P1c->Z4c+Z3c        (flux perm2):
    flx_calc_nr(22)= 202; flx_CalcIn(22)=iiPel; flx_option(22)=2
    flx_t(201)=+1.00;flx_SS(201)=1; flx_states(201)=ppP1c
    flx_ostates(201)=ppZ4c
    flx_t(202)=+1.00;flx_SS(202)=1; flx_states(202)=ppP1c
    flx_ostates(202)=ppZ3c

    ! jP6ZIc=P6c->Z4c+Z3c        (flux perm2):
    flx_calc_nr(23)= 204; flx_CalcIn(23)=iiPel; flx_option(23)=2
    flx_t(203)=+1.00;flx_SS(203)=1; flx_states(203)=ppP6c
    flx_ostates(203)=ppZ4c
    flx_t(204)=+1.00;flx_SS(204)=1; flx_states(204)=ppP6c
    flx_ostates(204)=ppZ3c

    ! jP1Z2c=P1c->Z2c        (flux perm2):
    flx_calc_nr(24)= 205; flx_CalcIn(24)=iiPel; flx_option(24)=2
    flx_t(205)=+1.00;flx_SS(205)=1; flx_states(205)=ppP1c
    flx_ostates(205)=ppZ2c

    ! jZ5ZIc=Z5c->Z4c+Z3c        (flux perm2):
    flx_calc_nr(25)= 207; flx_CalcIn(25)=iiPel; flx_option(25)=2
    flx_t(206)=+1.00;flx_SS(206)=1; flx_states(206)=ppZ5c
    flx_ostates(206)=ppZ4c
    flx_t(207)=+1.00;flx_SS(207)=1; flx_states(207)=ppZ5c
    flx_ostates(207)=ppZ3c

    ! jZ5Z2c=Z5c->Z2c        (flux perm2):
    flx_calc_nr(26)= 208; flx_CalcIn(26)=iiPel; flx_option(26)=2
    flx_t(208)=+1.00;flx_SS(208)=1; flx_states(208)=ppZ5c
    flx_ostates(208)=ppZ2c

    ! ntrDIn=N3n+N4n+R1n        (nettransport):
    flx_calc_nr(27)= 211; flx_CalcIn(27)=iiBen; flx_option(27)=60
    flx_t(209)=+1.00;flx_SS(209)=1; flx_states(209)=ppN3n;flx_ostates(209)=0
    flx_t(210)=+1.00;flx_SS(210)=1; flx_states(210)=ppN4n;flx_ostates(210)=0
    flx_t(211)=+1.00;flx_SS(211)=1; flx_states(211)=ppR1n;flx_ostates(211)=0

    ! ntr_ZPOn=B1n+P.n+R6n        (nettransport):
    flx_calc_nr(28)= 219; flx_CalcIn(28)=iiBen; flx_option(28)=60
    flx_t(212)=+1.00;flx_SS(212)=1; flx_states(212)=ppB1n;flx_ostates(212)=0
    flx_t(213)=+1.00;flx_SS(213)=1; flx_states(213)=ppP1n;flx_ostates(213)=0
    flx_t(214)=+1.00;flx_SS(214)=1; flx_states(214)=ppP2n;flx_ostates(214)=0
    flx_t(215)=+1.00;flx_SS(215)=1; flx_states(215)=ppP3n;flx_ostates(215)=0
    flx_t(216)=+1.00;flx_SS(216)=1; flx_states(216)=ppP4n;flx_ostates(216)=0
    flx_t(217)=+1.00;flx_SS(217)=1; flx_states(217)=ppP5n;flx_ostates(217)=0
    flx_t(218)=+1.00;flx_SS(218)=1; flx_states(218)=ppP6n;flx_ostates(218)=0
    flx_t(219)=+1.00;flx_SS(219)=1; flx_states(219)=ppR6n;flx_ostates(219)=0

    ! ntrDIp=N1p+R1p        (nettransport):
    flx_calc_nr(29)= 221; flx_CalcIn(29)=iiBen; flx_option(29)=60
    flx_t(220)=+1.00;flx_SS(220)=1; flx_states(220)=ppN1p;flx_ostates(220)=0
    flx_t(221)=+1.00;flx_SS(221)=1; flx_states(221)=ppR1p;flx_ostates(221)=0

    ! ntr_ZPOp=B1p+P.p+R6p        (nettransport):
    flx_calc_nr(30)= 229; flx_CalcIn(30)=iiBen; flx_option(30)=60
    flx_t(222)=+1.00;flx_SS(222)=1; flx_states(222)=ppB1p;flx_ostates(222)=0
    flx_t(223)=+1.00;flx_SS(223)=1; flx_states(223)=ppP1p;flx_ostates(223)=0
    flx_t(224)=+1.00;flx_SS(224)=1; flx_states(224)=ppP2p;flx_ostates(224)=0
    flx_t(225)=+1.00;flx_SS(225)=1; flx_states(225)=ppP3p;flx_ostates(225)=0
    flx_t(226)=+1.00;flx_SS(226)=1; flx_states(226)=ppP4p;flx_ostates(226)=0
    flx_t(227)=+1.00;flx_SS(227)=1; flx_states(227)=ppP5p;flx_ostates(227)=0
    flx_t(228)=+1.00;flx_SS(228)=1; flx_states(228)=ppP6p;flx_ostates(228)=0
    flx_t(229)=+1.00;flx_SS(229)=1; flx_states(229)=ppR6p;flx_ostates(229)=0

    ! ntrDIs=N5s        (nettransport):
    flx_calc_nr(31)= 230; flx_CalcIn(31)=iiBen; flx_option(31)=60
    flx_t(230)=+1.00;flx_SS(230)=1; flx_states(230)=ppN5s;flx_ostates(230)=0

    ! ntrPOs=P1s+P5s+R6s        (nettransport):
    flx_calc_nr(32)= 233; flx_CalcIn(32)=iiBen; flx_option(32)=60
    flx_t(231)=+1.00;flx_SS(231)=1; flx_states(231)=ppP1s;flx_ostates(231)=0
    flx_t(232)=+1.00;flx_SS(232)=1; flx_states(232)=ppP5s;flx_ostates(232)=0
    flx_t(233)=+1.00;flx_SS(233)=1; flx_states(233)=ppR6s;flx_ostates(233)=0

    ! ntrZIc=Z.c        (nettransport):
    flx_calc_nr(33)= 238; flx_CalcIn(33)=iiBen; flx_option(33)=60
    flx_t(234)=+1.00;flx_SS(234)=1; flx_states(234)=ppZ3c;flx_ostates(234)=0
    flx_t(235)=+1.00;flx_SS(235)=1; flx_states(235)=ppZ4c;flx_ostates(235)=0
    flx_t(236)=+1.00;flx_SS(236)=1; flx_states(236)=ppZ2c;flx_ostates(236)=0
    flx_t(237)=+1.00;flx_SS(237)=1; flx_states(237)=ppZ5c;flx_ostates(237)=0
    flx_t(238)=+1.00;flx_SS(238)=1; flx_states(238)=ppZ6c;flx_ostates(238)=0

    ! J1_PTc=P.c        (sedimentation 1):
    flx_calc_nr(34)= 245; flx_CalcIn(34)=iiBen; flx_option(34)=20
    flx_t(239)=+1.00;flx_SS(239)=1; flx_states(239)=ppP1c;flx_ostates(239)=1
    flx_t(240)=+1.00;flx_SS(240)=1; flx_states(240)=ppP2c;flx_ostates(240)=1
    flx_t(241)=+1.00;flx_SS(241)=1; flx_states(241)=ppP3c;flx_ostates(241)=1
    flx_t(242)=+1.00;flx_SS(242)=1; flx_states(242)=ppP4c;flx_ostates(242)=1
    flx_t(243)=+1.00;flx_SS(243)=1; flx_states(243)=ppP5c;flx_ostates(243)=1
    flx_t(244)=+1.00;flx_SS(244)=1; flx_states(244)=ppP6c;flx_ostates(244)=1
    flx_t(245)=+1.00;flx_SS(245)=1; flx_states(245)=ppPcc;flx_ostates(245)=1

    ! J1_R6c=R6c        (sedimentation 1):
    flx_calc_nr(35)= 246; flx_CalcIn(35)=iiBen; flx_option(35)=20
    flx_t(246)=+1.00;flx_SS(246)=1; flx_states(246)=ppR6c;flx_ostates(246)=1

    ! J1_R2c=R2c        (sedimentation 1):
    flx_calc_nr(36)= 247; flx_CalcIn(36)=iiBen; flx_option(36)=20
    flx_t(247)=+1.00;flx_SS(247)=1; flx_states(247)=ppR2c;flx_ostates(247)=1

    ! J0_Ndn=N.n        (sum bot):
    flx_calc_nr(37)= 249; flx_CalcIn(37)=iiBen; flx_option(37)=12
    flx_t(248)=+1.00;flx_SS(248)=1; flx_states(248)=ppN3n
    flx_ostates(248)=ppN3n
    flx_t(249)=+1.00;flx_SS(249)=1; flx_states(249)=ppN4n
    flx_ostates(249)=ppN4n

    ! J0_Ntn=N.n+P.n+R6n        (sum bot):
    flx_calc_nr(38)= 258; flx_CalcIn(38)=iiBen; flx_option(38)=12
    flx_t(250)=+1.00;flx_SS(250)=1; flx_states(250)=ppN3n
    flx_ostates(250)=ppN3n
    flx_t(251)=+1.00;flx_SS(251)=1; flx_states(251)=ppN4n
    flx_ostates(251)=ppN4n
    flx_t(252)=+1.00;flx_SS(252)=1; flx_states(252)=ppP1n
    flx_ostates(252)=ppP1n
    flx_t(253)=+1.00;flx_SS(253)=1; flx_states(253)=ppP2n
    flx_ostates(253)=ppP2n
    flx_t(254)=+1.00;flx_SS(254)=1; flx_states(254)=ppP3n
    flx_ostates(254)=ppP3n
    flx_t(255)=+1.00;flx_SS(255)=1; flx_states(255)=ppP4n
    flx_ostates(255)=ppP4n
    flx_t(256)=+1.00;flx_SS(256)=1; flx_states(256)=ppP5n
    flx_ostates(256)=ppP5n
    flx_t(257)=+1.00;flx_SS(257)=1; flx_states(257)=ppP6n
    flx_ostates(257)=ppP6n
    flx_t(258)=+1.00;flx_SS(258)=1; flx_states(258)=ppR6n
    flx_ostates(258)=ppR6n

    ! qqrivO3c=O3c        (riv):
    flx_calc_nr(39)= 259; flx_CalcIn(39)=iiBen; flx_option(39)=50
    flx_t(259)=+1.00;flx_SS(259)=1; flx_states(259)=ppO3c;flx_ostates(259)=0

    ! qqrivO3h=O3h        (riv):
    flx_calc_nr(40)= 260; flx_CalcIn(40)=iiBen; flx_option(40)=50
    flx_t(260)=+1.00;flx_SS(260)=1; flx_states(260)=ppO3h;flx_ostates(260)=0

    ! qqriv_w= 1        (riv):
    flx_calc_nr(41)= 261; flx_CalcIn(41)=iiBen; flx_option(41)=50
    flx_t(261)=+1.00;flx_SS(261)=1; flx_states(261)=0;flx_ostates(261)=0

    ! qqrivNtn=N3n+N4n+R1n+R6n        (riv):
    flx_calc_nr(42)= 265; flx_CalcIn(42)=iiBen; flx_option(42)=50
    flx_t(262)=+1.00;flx_SS(262)=1; flx_states(262)=ppN3n;flx_ostates(262)=0
    flx_t(263)=+1.00;flx_SS(263)=1; flx_states(263)=ppN4n;flx_ostates(263)=0
    flx_t(264)=+1.00;flx_SS(264)=1; flx_states(264)=ppR1n;flx_ostates(264)=0
    flx_t(265)=+1.00;flx_SS(265)=1; flx_states(265)=ppR6n;flx_ostates(265)=0

    ! qqrivNtp=N1p+R1p+R6p        (riv):
    flx_calc_nr(43)= 268; flx_CalcIn(43)=iiBen; flx_option(43)=50
    flx_t(266)=+1.00;flx_SS(266)=1; flx_states(266)=ppN1p;flx_ostates(266)=0
    flx_t(267)=+1.00;flx_SS(267)=1; flx_states(267)=ppR1p;flx_ostates(267)=0
    flx_t(268)=+1.00;flx_SS(268)=1; flx_states(268)=ppR6p;flx_ostates(268)=0

    ! qqrivR6p=R6p        (riv):
    flx_calc_nr(44)= 269; flx_CalcIn(44)=iiBen; flx_option(44)=50
    flx_t(269)=+1.00;flx_SS(269)=1; flx_states(269)=ppR6p;flx_ostates(269)=0
