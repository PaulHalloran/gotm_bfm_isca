...
!        RZc                        FaecelPellet Particulate Carbon (POC)          mgC/m3
!        O3c                                   dissolved inorganic carbon         mgC /m3
...
!        G3c                                         CO2 in aerobic layer          mgC/m2
!        G3h                                  alkalinity in aerobic layer          mol/kg
!       G13c                                 CO2 in denitrification layer          mgC/m2
!       G13h                          alkalinity in denitrification layer          mol/kg
!       G23c                                       CO2 in anaerobic layer          mgC/m2
!       G23h                                alkalinity in anaerobic layer          mol/kg
    ...
    real(RLEN),public,pointer,dimension(:,:) :: D2DIAGNOS
        ...
        integer,parameter,public  ::NO_D2_BOX_STATES= 61

        integer,parameter,public  ::NO_D3_BOX_DIAGNOSS= 197

        integer,parameter,public  ::NO_D2_BOX_DIAGNOSS= 304

        integer,parameter,public  ::NO_D3_BOX_FLUX= 9

        integer,parameter,public  ::NO_D2_BOX_FLUX= 35
    ...
    integer,parameter,public :: ppR9x=1, ppO2o=2, ppN1p=3, ppN3n=4, ppN4n=5,&
     ...
     ppR7c=48, ppRZc=49, ppO3c=50, ppO3h=51, ppZ3c=52, ppZ4c=53, ppZ2c=54,&
     ppZ5c=55, ppZ6c=56, ppP2s=0, ppP3s=0, ppP4s=0, ppP6s=0, ppR1s=0,&
     ppR2n=0, ppR2p=0, ppR2s=0, ppR3n=0, ppR3p=0, ppR3s=0, ppR7n=0, ppR7p=0,&
     ppR7s=0, ppZ3n=0, ppZ3p=0, ppZ4n=0, ppZ4p=0, ppZ2n=0, ppZ2p=0, ppZ5n=0,&
     ppZ5p=0, ppZ6n=0, ppZ6p=0
    ...
    real(RLEN),public,dimension(:),pointer :: R9x, O2o, N1p, N3n, N4n, O4n,&
     ...
     P6n, P6p, P6l, Pcc, R1c, R1n, R1p, R2c, R3c, R6c, R6n, R6p, R6s, R7c,&
     RZc, O3c, O3h, Z3c, Z4c, Z2c, Z5c, Z6c
    ...
    integer,parameter,public :: ppY1c=1, ppY1n=2, ppY1p=3, ppY2c=4, ppY2n=5,&
     ...
     ppH3n=34, ppH3p=35, ppK1p=36, ppK11p=37, ppK21p=38, ppK4n=39,&
     ppK14n=40, ppK24n=41, ppK3n=42, ppK5s=43, ppK15s=44, ppK6r=45,&
     ppK16r=46, ppK26r=47, ppG2o=48, ppG4n=49, ppD1m=50, ppD2m=51, ppD6m=52,&
     ppD7m=53, ppD8m=54, ppD9m=55, ppG3c=56, ppG3h=57, ppG13c=58, ppG13h=59,&
     ppG23c=60, ppG23h=61
    ...
    real(RLEN),public,dimension(:),pointer :: Y1c, Y1n, Y1p, Y2c, Y2n, Y2p,&
     ...
     K16r, K26r, G2o, G4n, D1m, D2m, D6m, D7m, D8m, D9m, G3c, G3h, G13c,&
     G13h, G23c, G23h
    ...
    integer,parameter,public :: iiPelDetritus=5, iiR1=1, iiR2=2, iiR3=3,&
     iiR6=4, iiR7=5
...
!       PrAc                                               H+ in sediment    mmolH+/m3 pw
!       PrpH                                               Ph in sediment               -
...
! EPLi(iiP6)                           Optimal light in P6(PhytoPlankton)            W/m2
    ...
    integer,parameter,public :: ppETW=1, ppESW=2, ppEIR=3,&
     ...
     ppflN3O4n=14, ppflR3R2c=15, pprumn4B=16, pprumn3B=17, pprumnuB=18,&
     pprumpB=19, pprumpuB=20, pplim_rumn4=21, pplim_rumn3=22, pplim_rumnu=23,&
     pplim_rump1=24, pplim_rumpu=25, pplim_rums5=26, pprml=27, ppqpR6c=28,&
     ppqnR6c=29, ppqsR6c=30, ppqpB1c=31, ppqnB1c=32, pppMIupZ4=33,&
     pprnetPTc=34, ppflnDIn=35, ppflnDIp=36, ppsediR2=37, ppsediR6=38,&
     ppsediRZ=39, ppPTi=40, pplimnuti=41, ppxEPS=42, ppxEPS_0=43,&
     ppxEPS_ESS=44, ppxEPS_Chl=45, pppCO2=46, ppCO2=47, ppHCO3=48, ppCO3=49,&
     pppH=50, ppAc=51, ppDIC=52, ppPrM1p=53, ppPr2M1p=54, ppPrM3n=55,&
     ppPrM4n=56, ppPrM5s=57, ppPrM6r=58, ppPrQ1c=59, ppPrDIC=60, ppPrAc=61,&
     ppPrpH=62
    ...
    real(RLEN),public,dimension(:),pointer :: ETW, ESW, EIR, ERHO, ESS,&
     cxoO2, XO2o, eO2mO2, Chla, Xantho, flP6R3c, flPTN6r, flN4N3n, flN3O4n,&
     flR3R2c, rumn4B, rumn3B, rumnuB, rumpB, rumpuB, lim_rumn4, lim_rumn3,&
     ...
     PTi, limnuti, xEPS, xEPS_0, xEPS_ESS, xEPS_Chl, pCO2, CO2, HCO3, CO3,&
     pH, Ac, DIC, PrM1p, Pr2M1p, PrM3n, PrM4n, PrM5s, PrM6r, PrQ1c, PrDIC,&
     PrAc, PrpH
...
!     jPIY3n                     Phytoplankton filtered by filter feeders     mmol N/m2/d
!     jPIY3p                     Phytoplankton filtered by filter feeders     mmol P/m2/d
...
!    R3_Benn                                                 TEP in Pheao        mmolN/m3
!    R3_Benp                                                 TEP in Pheao        mmolP/m3
...
!    jeZIR6n                     detritus exretion meso+micro zooplankton        mgN/m2/d
!    jeZIR6p                     detritus exretion meso+micro zooplankton        mgP/m2/d
!    jeZIDIn                          loc exretion meso+micro zooplankton        mgN/m2/d
!    jeZIDIp                          loc exretion meso+micro zooplankton        mgP/m2/d
...
!      CO2ae                                            CO2 concentration          mol/kg
!     HCO3ae                                          HCO3- concentration          mol/kg
!      CO3ae                                          CO3-- concentration          mol/kg
!   jG33G23h                    alkalinity flux at lower benthic boundary       mmol/m2/d
!   jG33G23c                        flux of DIC at lower benthic boundary        mgC/m2/d
...
! sediPI_Ben(iiP6)                         P6(PhytoPlankton) sedimentation rate             m/d
    ...
    integer,parameter,public :: ppEUWIND=1, ppEVWIND=2, ppETAUB=3,&
     ...
     ppM6r=24, ppRI_Fc=25, ppRI_Fn=26, ppRI_Fp=27, ppRI_Fs=28,&
     ppZI_Fc=29, ppZI_Fn=30, ppZI_Fp=31, ppZI_Fs=32,&
     ppjPIY3n=33, ppjPIY3p=34, ppjZIY3c=35, ppjRIY3c=36,&
     ppjY3QIc=37, ppjY3QIs=38, ppjY3RIc=39, ppjY3RIn=40,&
     ppjY3RIp=41, ppjY3RIs=42, ppjRIQIc=43, ppjRIQIn=44,&
     ppjRIQIp=45, ppjRIQIs=46, ppjY3O3c=47, ppjO2Y3o=48,&
     ppjY3N4n=49, ppjY3N1p=50, ppDepth_Ben=51, ppETW_Ben=52,&
     ppERHO_Ben=53, ppESW_Ben=54, pppuP6Y3=55, ppR3_Benc=56,&
     ppR3_Benn=57, ppR3_Benp=58, ppO2o_Ben=59, ppN1p_Ben=60,&
     ppN3n_Ben=61, ppN4n_Ben=62, ppN5s_Ben=63, ppN6r_Ben=64,&
     ppsediR6_Ben=65, ppefilP6Y3=66, pppyfoodY3=67, ppctfPm2c=68,&
     ppctfZm2c=69, ppctfRm2c=70, ppcZ2m2c=71, ppsK4K3=72,&
     ppjK4K3n=73, ppjK3G4n=74, ppjK31K21p=75, ppjK34K24n=76,&
     ppjK13K3n=77, ppjK25K15s=78, ppjK36K26r=79, pptotPELc=80,&
     pptotPELn=81, pptotPELp=82, pptotPELs=83, pptotBENc=84,&
     pptotBENn=85, pptotBENp=86, pptotBENs=87, pptotSYSc=88,&
     pptotSYSn=89, pptotSYSp=90, pptotSYSs=91, ppjtotbenpelc=92,&
     ppjtotbenpeln=93, ppjtotbenpelp=94, ppjtotbenpels=95, ppjupPELc=96,&
     ppjminPELc=97, ppjupBENc=98, ppjminBENc=99, pptotPELInc=100,&
     pptotBENInc=101, pptotPELh=102, pptotBENh=103, ppjsdoMesoc=104,&
     ppjrsMicroc=105, ppjnetPTc=106, ppjnetMeZc=107, ppjnetMiZc=108,&
     ppjnetB1c=109, ppjeZIR6n=110, ppjeZIR6p=111, ppjeZIDIn=112,&
     ppjeZIDIp=113, ppjnetY3c=114, ppjnetYy3c=115, ppjCaCO3Y3c=116,&
     ppOutput2d_1=117, ppOutput2d_2=118, ppOutput2d_3=119, ppOutput2d_4=120,&
     ppjPelFishInput=121, ppjBenFishInput=122, ppSdTdzTh=123, ppTMLd=124,&
     ppBMLd=125, ppDICae=126, ppDICan=127, ppO3c_Ben=128, ppO3h_Ben=129,&
     ppctO3m2h=130, ppAcae=131, ppAcan=132, pppHae=133, pppHan=134,&
     pppCO2ae=135, pppCO2an=136, ppCO2ae=137, ppHCO3ae=138, ppCO3ae=139,&
     ppjG33G23h=140, ppjG33G23c=141
    ...
    real(RLEN),public,dimension(:),pointer :: EUWIND, EVWIND, ETAUB, rrBTo,&
     ...
     shiftD2m, jG2K3o, jG2K7o, M1p, M11p, M21p, M4n, M14n,&
     M24n, M3n, M5s, M6r, RI_Fc, RI_Fn, RI_Fp, RI_Fs,&
     ZI_Fc, ZI_Fn, ZI_Fp, ZI_Fs, jPIY3n, jPIY3p, jZIY3c,&
     jRIY3c, jY3QIc, jY3QIs, jY3RIc, jY3RIn, jY3RIp, jY3RIs,&
     jRIQIc, jRIQIn, jRIQIp, jRIQIs, jY3O3c, jO2Y3o, jY3N4n,&
     jY3N1p, Depth_Ben, ETW_Ben, ERHO_Ben, ESW_Ben, puP6Y3, R3_Benc,&
     R3_Benn, R3_Benp, O2o_Ben, N1p_Ben, N3n_Ben, N4n_Ben, N5s_Ben,&
     N6r_Ben, sediR6_Ben, efilP6Y3, pyfoodY3, ctfPm2c, ctfZm2c, ctfRm2c,&
     cZ2m2c, sK4K3, jK4K3n, jK3G4n, jK31K21p, jK34K24n, jK13K3n,&
     jK25K15s, jK36K26r, totPELc, totPELn, totPELp, totPELs, totBENc,&
     totBENn, totBENp, totBENs, totSYSc, totSYSn, totSYSp, totSYSs,&
     jtotbenpelc, jtotbenpeln, jtotbenpelp, jtotbenpels, jupPELc, jminPELc,&
     jupBENc, jminBENc, totPELInc, totBENInc, totPELh, totBENh, jsdoMesoc,&
     jrsMicroc, jnetPTc, jnetMeZc, jnetMiZc, jnetB1c, jeZIR6n, jeZIR6p,&
     jeZIDIn, jeZIDIp, jnetY3c, jnetYy3c, jCaCO3Y3c, Output2d_1,&
     Output2d_2, Output2d_3, Output2d_4, jPelFishInput, jBenFishInput,&
     SdTdzTh, TMLd, BMLd, DICae, DICan, O3c_Ben, O3h_Ben, ctO3m2h, Acae,&
     Acan, pHae, pHan, pCO2ae, pCO2an, CO2ae, HCO3ae, CO3ae, jG33G23h,&
     jG33G23c
    ...
    real(RLEN),public,dimension(:),pointer :: jsurR9x, jsurO2o, jsurN1p,&
     ...
     jsurR6c, jsurR6n, jsurR6p, jsurR6s, jsurR7c, jsurRZc, jsurO3c, jsurO3h,&
     jsurZ3c, jsurZ4c, jsurZ2c, jsurZ5c, jsurZ6c
    ...
    real(RLEN),public,dimension(:),pointer :: jbotR9x, jbotO2o, jbotN1p,&
     ...
     jbotR6c, jbotR6n, jbotR6p, jbotR6s, jbotR7c, jbotRZc, jbotO3c, jbotO3h,&
     jbotZ3c, jbotZ4c, jbotZ2c, jbotZ5c, jbotZ6c
    ...
    public ppPhytoPlankton, ppPelDetritus, ppInorganic,&
     ppMesoZooPlankton, ppMicroZooPlankton, PhytoPlankton, PelDetritus,&
     Inorganic, MesoZooPlankton, MicroZooPlankton

    public ppBenOrganisms, ppBenLabileDetritus, ppBenBacteria,&
     ppBenthicPhosphate, ppBenthicAmmonium, ppBenthicCO2, BenOrganisms,&
     BenLabileDetritus, BenBacteria, BenthicPhosphate, BenthicAmmonium,&
     BenthicCO2
    ...
    function ppPelDetritus(n,constituent)
     ...
     integer,dimension(5) :: referto=[ppR1c,ppR2c,ppR3c,ppR6c,ppR7c]
     integer,dimension(5) :: const_max=[3,1,1,5,1]
